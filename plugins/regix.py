...
async def pub_(bot, message):
    ...
    await send(client, user, "<b>ғᴏʀᴡᴀʀᴅɪɴɢ sᴛᴀʀᴛᴇᴅ <a href=https://t.me/xptoolsteam>XP Tools Team</a></b>")
    sts.add(time=True)
    ...
    if locked:
        try:
          ...
          async for message in client.iter_messages(
            ...
            return await stop(client, user)
        temp.IS_FRWD_CHAT.remove(sts.TO)
        await send(client, user, "<b>🎉 ғᴏʀᴡᴀᴅɪɴɢ ᴄᴏᴍᴘʟᴇᴛᴇᴅ 🥀 <a href=https://t.me/nextgenroom>SUPPORT</a>🥀</b>")
...
async def edit(msg, title, status, sts):
   ...
   if status in ["cancelled", "completed"]:
      button.append(
         [InlineKeyboardButton('Support', url='https://t.me/nextgenroom'),
         InlineKeyboardButton('Updates', url='https://t.me/xptoolsteam')]
         )
   else:
