...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/xptoolsteam')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/nextgenroom'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/xptoolsteam')
        ],[
